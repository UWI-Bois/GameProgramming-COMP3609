...
public class GameFrame extends JFrame implements Runnable, KeyListener {
	...
	private AnimFlip animation = null;		// animation sprite for disappearing effect
	...
	public GameFrame () {
		...
		ball = new Ball (this, bat, 0, 0, 0, 10, 20, 20, "images/ball.gif");   					animation = new AnimFlip (this, 20, 50, 15, 15, 250, 250, "images/player1.png");
