package com.brackeen.javagamebook.graphics.input;
    ...
    MouseMotionListener, MouseWheelListener
{
    ...
    */
    ...
    private com.brackeen.javagamebook.input.GameAction[] keyActions =
        new com.brackeen.javagamebook.input.GameAction[NUM_KEY_CODES];
    private com.brackeen.javagamebook.input.GameAction[] mouseActions =
        new com.brackeen.javagamebook.input.GameAction[NUM_MOUSE_CODES];
    ...
    */
    ...
    /**
        ...
        it.
    */
    public void mapToKey(com.brackeen.javagamebook.input.GameAction gameAction, int keyCode) {
    ...
    /**
        ...
        it.
    */
    public void mapToMouse(com.brackeen.javagamebook.input.GameAction gameAction,
                           int mouseCode)
    {
    ...
    /**
        ...
        GameAction.
    */
    public void clearMap(com.brackeen.javagamebook.input.GameAction gameAction) {
    ...
    */
    public List getMaps(com.brackeen.javagamebook.input.GameAction gameCode) {
    ...
    */
    ...
    private com.brackeen.javagamebook.input.GameAction getKeyAction(KeyEvent e) {
    ...
    */
    ...
    private com.brackeen.javagamebook.input.GameAction getMouseButtonAction(MouseEvent e) {
    ...
    public void keyPressed(KeyEvent e) {
        com.brackeen.javagamebook.input.GameAction gameAction = getKeyAction(e);
        if (gameAction != null) {
            gameAction.press();
        }
    ...
    public void mousePressed(MouseEvent e) {
        com.brackeen.javagamebook.input.GameAction gameAction = getMouseButtonAction(e);
        if (gameAction != null) {
            gameAction.press();
        }
    }
    ...
    private void mouseHelper(int codeNeg, int codePos,
        int amount)
    {
        com.brackeen.javagamebook.input.GameAction gameAction;
        if (amount < 0) {
