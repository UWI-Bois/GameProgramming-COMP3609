...
public class GameManager extends GameCore {
    ...
    private com.brackeen.javagamebook.input.GameAction moveLeft;
    private com.brackeen.javagamebook.input.GameAction moveRight;
    private com.brackeen.javagamebook.input.GameAction jump;
    private com.brackeen.javagamebook.input.GameAction exit;
...
/* init1 written by P. Mohan on February 8, 2019 */
    ...
    */
    ...
    private void initInput() {
        moveLeft = new com.brackeen.javagamebook.input.GameAction("moveLeft");
        moveRight = new com.brackeen.javagamebook.input.GameAction("moveRight");
        jump = new com.brackeen.javagamebook.input.GameAction("jump",
                com.brackeen.javagamebook.input.GameAction.DETECT_INITAL_PRESS_ONLY);
        exit = new com.brackeen.javagamebook.input.GameAction("exit",
                com.brackeen.javagamebook.input.GameAction.DETECT_INITAL_PRESS_ONLY);
